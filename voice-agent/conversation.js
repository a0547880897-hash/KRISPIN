...
const GREETING_INSTRUCTIONS =
  'פתחי בעברית קצר וקליל: הציגי את עצמך כיועצת של בנק יהב במשפט אחד, ואז שאלי שאלת פתיחה אחת — "איפה את/ה מנהל/ת את החשבון היום?" משפט אחד, ואז עצרי והקשיבי. בלי לדקלם, בלי "מצוין".';
