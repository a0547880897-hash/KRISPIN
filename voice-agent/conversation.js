...
const GREETING_INSTRUCTIONS =
  'פתח את השיחה בעברית, בחום ובקצרה: הצג את עצמך כסוכן של בנק יהב, ושאל שאלת פתיחה אחת קצרה כדי להבין עם מי אתה מדבר (למשל איפה הם מנהלים חשבון היום או מה חשוב להם בבנק). משפט אחד או שניים בלבד, ואז עצור והקשב.';
